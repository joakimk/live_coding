...
var _user$example$Types$GithubGistMetadata = F2(
	function (a, b) {
		return {user: a, id: b};
	});
...
var _user$example$Types$CodeChangedByUser = function (a) {
	return {ctor: 'CodeChangedByUser', _0: a};
};
...
var _user$example$Helpers$reloadProject = F2(
...
var _user$example$Helpers$buildGithubProjectMetadata = function (url) {
...
var _user$example$State$loadCodeFromGist = _elm_lang$core$Native_Platform.outgoingPort(
	'loadCodeFromGist',
	function (v) {
		return v;
	});
var _user$example$State$loadCodeFromProject = function (project) {
	var _p0 = _user$example$Helpers$detectCodeUrlType(project);
	switch (_p0.ctor) {
		case 'Github':
			return {
...
var _user$example$State$loadCodeInEditor = _elm_lang$core$Native_Platform.outgoingPort(
	'loadCodeInEditor',
	function (v) {
		return {
			remoteCodeUrl: v.remoteCodeUrl,
		...
		switch (_p2.ctor) {
			...
			case 'OpenProject':
				...
				return A2(
					...
					_elm_lang$core$List$concat(
						{
							ctor: '::',
							_0: _user$example$State$fetchRemoteFiles(_p3),
							_1: {
								ctor: '::',
								_0: {
									ctor: '::',
									_0: _user$example$State$loadCodeInEditor(
										{remoteCodeUrl: _p3.remoteCodeUrl, localFiles: _p3.localFiles}),
									_1: {ctor: '[]'}
								},
								_1: {ctor: '[]'}
							}
			...
			case 'RemoteCodeLoaded':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{projects: projects}),
					{ctor: '[]'});
			case 'ReplaceLocalFilesWithRemoteFiles':
				var _p8 = _p2._0;
				var projects = A2(
					_elm_lang$core$List$map,
					function (p) {
					...
					model.projects);
				var updatedProject = A2(_user$example$Helpers$reloadProject, projects, _p8);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'CodeChangedByUser':
				...
				var projects = A2(
					_elm_lang$core$List$map,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.remoteCodeUrl, _p9.remoteCodeUrl) ? _elm_lang$core$Native_Utils.update(
							p,
							{localFiles: _p9.localFiles}) : p;
					},
					model.projects);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$example$State$updateAndSaveSettings = F2(
	function (msg, model) {
		var _p10 = A2(_user$example$State$update, msg, model);
		...
		return {
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$example$State$saveSettings(
						_user$example$State$dumpSettings(newModel)),
					_1: {
						ctor: '::',
						_0: cmds,
						_1: {ctor: '[]'}
...
var _user$example$State$codeChangedByUser = _elm_lang$core$Native_Platform.incomingPort(
	'codeChangedByUser',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (remoteCodeUrl) {
			return A2(
				...
				function (localFiles) {
					return _elm_lang$core$Json_Decode$succeed(
						{remoteCodeUrl: remoteCodeUrl, localFiles: localFiles});
				},
				A2(
					_elm_lang$core$Json_Decode$field,
					'localFiles',
			...
			return _elm_lang$core$Platform_Sub$batch(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$example$State$codeChangedByUser(_user$example$Types$CodeChangedByUser),
							_1: {ctor: '[]'}
						}
					}
				});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$example$Main$main !== 'undefined') {
    _user$example$Main$main(Elm['Main'], 'Main', undefined);
}
